            ...
            <div class="uk-container">
                <div class="uk-grid-medium" data-uk-grid>
                    <div class="uk-width-expand@m">
                        <img class="uk-margin-small-right in-margin-top-30@s" src="img/in-lazy.gif" data-src="img/logo-main.png" alt="wave" width="134" height="23" data-uk-img>
                        <p class="uk-text-large uk-margin-small-top">Address.</p>
                        <p class="uk-visible@m">No. 16 Gidaje Plaza,<br>
                            Behind Total Filing Station,<br>
                            Zoo road, Kano, Nigeria.<br>
                        </p>
                    </div>
            ...
            <div class="uk-container">
                <div class="uk-grid">
                    ...
                    <div class="uk-width-expand@m uk-text-right@m">
                        <p>© 2020 AKMarkets Capital Inc.</p>
                    </div>
                </div>
            </div>
        </div>
