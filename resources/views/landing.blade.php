        ...
        <ul class="uk-slideshow-items uk-light">
            <li>
                <div class="uk-position-cover">
                    <img src="img/in-lazy.gif" data-src="{{asset('assets')}}/banner/banner-1.jpg" alt="slideshow-image" data-uk-cover width="1920" height="700" data-uk-img>
                </div>
                <span></span>
            ...
            <li>
                <div class="uk-position-cover">
                    <img src="img/in-lazy.gif" data-src="{{asset('assets')}}/banner/banner-2.jpg" alt="slideshow-image" data-uk-cover width="1920" height="700" data-uk-img>
                </div>
                <span></span>
                <div class="uk-container">
                    <div class="uk-grid" data-uk-grid>
            ...
            <li>
                <div class="uk-position-cover">
                    <img src="img/in-lazy.gif" data-src="{{asset('assets')}}/banner/banner-3.jpg" alt="slideshow-image" data-uk-cover width="1920" height="700" data-uk-img>
                </div>
                <span></span>
                <div class="uk-container">
                    <div class="uk-grid" data-uk-grid>
                ...
                <div class="uk-grid-medium uk-child-width-1-2@s uk-child-width-1-3@m uk-text-center uk-margin-medium-top" data-uk-grid>
                    <div>
                        <div class="uk-card uk-card-default uk-card-body uk-border-rounded">
                            <img class="uk-margin-remove-bottom" src="{{asset('assets')}}/img/in-lazy.gif" data-src="{{asset('assets')}}/img/in-wave-icon-6.svg" alt="wave-icon" width="52" height="52" data-uk-img>
                            <h5 class="uk-margin-small-top">Strategies &amp; Discussions</h5>
                        </div>
                    </div>
                    <div>
                        <div class="uk-card uk-card-default uk-card-body uk-border-rounded">
                            <img class="uk-margin-remove-bottom" src="{{asset('assets')}}/img/in-lazy.gif" data-src="{{asset('assets')}}/img/in-wave-icon-7.svg" alt="wave-icon" width="52" height="52" data-uk-img>
    ...
    <div class="uk-container">
        <div class="uk-grid">
            <div class="uk-width-1-1 uk-background-contain uk-background-center-right uk-background-image@m" style="background-image: url(img/in-wave-mockup-1.png);">
                ...
                <p class="uk-text-lead">on <span class="uk-text-primary">XM</span> mobile app.</p>
